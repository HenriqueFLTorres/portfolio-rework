  ...
  return (
    <section id="projects" className="relative w-max mx-auto mb-72">
      ...
      <a
        ...
        rel="noreferrer"
        className={
          'flex items-center justify-center w-full rounded-full mx-auto bg-white text-neutral-800 hover:bg-neutral-400 font-bold py-3 cursor-pointer transition-colors'
        }
      >
        {isEnglish
